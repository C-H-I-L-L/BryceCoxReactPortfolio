  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://wubbalubbadubbdubb.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch" //any time you want to edit something, this is the verb to use
      });
    }
  }
          ...
          {this.props.editMode && this.props.blog.featured_image_url ? (
            <div className="portfolio-manager-image-wrapper">
              ...
              <div className="image-removal-link">
                <a href="#" onClick={() => this.deleteImage("featured_image")}>
                  Remove file
                </a>
              </div>
            </div>
